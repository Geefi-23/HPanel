  ...
  <main>
    <div class="dashboard">
      <a href="noticias/postar" class="functional-card">
        ...
        <span>Use esta área para postagem de notícias.</span>
      </a>
      <a href="evento/postar" class="functional-card">
        <h4>Postar Evento</h4>
        <span>Use esta área para postagem de eventos.</span>
      </a>
      <a href="noticias/comentarios" class="functional-card">
        <h4>Gerenciar comentários</h4>
        <span>Área destinada ao gerenciamento geral de todos os comentarios em qualquer tópico ou post.</span>
      </a>
      <a href="noticias/gerenciar" class="functional-card">
        <h4>Gerenciar notícias</h4>
        <span>Área destinada ao gerenciamento geral de todos as notícias da plataforma.</span>
      </a>
    </div>
