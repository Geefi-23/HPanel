...
<head>
  ...
  <title>HPanel | Postar emblema</title>
</head>
<body>
  ...
  <div style="flex: 1">
    ...
    <main class="p-3">
      ...
      <form class="post-form" action="#" name="emblemas">
        ...
        <input name="codigo" placeholder="Código" autocomplete="off" />
        <input name="conquistado" placeholder="Onde foi conquistado" autocomplete="off" />
        <input name="usuarios_qtd" placeholder="Quantos usuários possuem este emblema?" type="number" autocomplete="off" />
        <div>
  ...
  <script src="/painel/assets/js/noticias/postar_emblema.js" type="module"></script>
</body>
</html>