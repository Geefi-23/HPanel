...
<head>
  ...
  <title>HPainel | Rádio pedidos</title>
</head>
<body>
  ...
  <div style="flex: 1">
    ...
    <main class="p-5">
      <div class="container">
        <table id="table-pedidos" class="table table-hover border mt-2">
          <th>ID</th>
          <th>Usuario</th>
          <th>Pedido</th>
          <th>Hora</th>
  ...
  <script src="/painel/assets/js/radio/pedidos.js" type="module"></script>
</body>
</html>